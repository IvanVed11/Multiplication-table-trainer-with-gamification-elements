...
mul_table = defaultdict(list, {"1":[[1,1,1],[1,2,2],[1,3,3],[1,4,4],[1,5,5],[1,6,6],[1,7,7],[1,8,8],[1,9,9]],
...
titles = defaultdict(int, {0: "👨‍💻 Табличный Разведчик - «Загрузка знаний началась!»",
                           10: "📟 Мастер Кнопок - «Твой процессор разогревается!»",
                           30: "🤖 Кибер-Ученик - «Ошибки стерты из памяти.»",
                           60: "🥷 Цифровой Ниндзя - «Таблица умножения тебя боится!»",
                           100: "🧠 Кибер-Гений - «Твой мозг работает на сверхскорости!»",
                           200: "⚙ Повелитель Цифр - «Ты управляешь миром чисел!»",
                           400: "👑 Сверхразум Умножения - «Система достигла совершенства.»"})